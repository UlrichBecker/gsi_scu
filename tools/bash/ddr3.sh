...
# Posix didnt support any arrays or for loops, Posix supports only while loops echo "-----------------------------------------------------------------------------------------"
