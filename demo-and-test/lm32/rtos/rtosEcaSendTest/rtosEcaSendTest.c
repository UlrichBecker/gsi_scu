/*!
 * @file rtosEcaSendTest.c
 * @brief Test program for FreeRTOS with sending an ECA-event to itself on SCU-LM32
 *
...
void main( void )
{
   mprintf( ESC_XY( "1", "1" ) ESC_CLR_SCR "FreeRTOS ECA-Send test\n"
